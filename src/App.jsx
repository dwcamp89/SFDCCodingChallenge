define(
	...
	renderProductSelector = function() {
		ReactDOM.render(
			<ProductSelector invoiceProducts={state.currentInvoice.getProducts()} />,
	...
	renderOrderForm = function() {
		ReactDOM.render(
			<OrderForm invoice={state.currentInvoice} />,
	...
	renderInvoice = function() {
		ReactDOM.render(
			<InvoiceDisplay invoice={state.currentInvoice} isNewInvoice={true} />,
	...
	renderExistingInvoice = function() {
		ReactDOM.render(
			<InvoiceDisplay invoice={state.currentInvoice} isNewInvoice={false} />,
			document.getElementById('invoiceDisplayContainer')
		);
	}
	...
	renderInvoiceSelector = function() {
		ReactDOM.render(
			<InvoiceSelector invoices={state.invoiceList} />,
